...
>>>>>>> 929dc715917b5441bce64acca5799caa9213b797
...
=======
    ...
    string consulta = "select* from ignacio.simulacion where " ;
    ...
    {
        var banco = DropDownList1.SelectedItem.ToString();
        ViewState["Banco"]=banco;
    }
   

    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        var monto = DropDownList2.SelectedItem.ToString();
    }
    ...
    {
        consulta = consulta + " tasa < @tasamayor and tasa> @tasamenor";
    }
